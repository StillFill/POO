			...
			<div className="navbar-container">
				...
				>
					<div style={{ marginTop: '1rem' }}>
						...
						<FormControl value={this.state.name} onChange={this.handleInputChange} name="name" />
					</div>
					<div style={{ marginTop: '1rem' }}>
						<ControlLabel>Email</ControlLabel>
						<FormControl value={this.state.email} onChange={this.handleInputChange} name="email" />
					</div>
					<div style={{ marginTop: '1rem' }}>
						<ControlLabel>Senha</ControlLabel>
						<FormControl
