...
class Search extends Component {
  ...
  addToCart() {
    ...
    if (user) {
      ...
      if (userCart && userCart.classes.includes(classId)) {
        Bert.alert("Curso ja existe no carrinho", "danger");
      } else {
      ...
      if (cart && cart.classes.includes(classId)) {
        return Bert.alert("Curso ja existe no carrinho", "danger");
      }
      if (!!cart) {
        const newCart = cart;
